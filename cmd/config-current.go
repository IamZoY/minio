...
import (
	...
	"github.com/iamzoy/minio/internal/config/drive"
	"github.com/iamzoy/minio/internal/config/etcd"
	"github.com/iamzoy/minio/internal/config/heal"
	xldap "github.com/iamzoy/minio/internal/config/identity/ldap"
	"github.com/iamzoy/minio/internal/config/identity/openid"
	idplugin "github.com/iamzoy/minio/internal/config/identity/plugin"
	xtls "github.com/iamzoy/minio/internal/config/identity/tls"
	"github.com/iamzoy/minio/internal/config/ilm"
	"github.com/iamzoy/minio/internal/config/lambda"
	"github.com/iamzoy/minio/internal/config/notify"
	"github.com/iamzoy/minio/internal/config/policy/opa"
	polplugin "github.com/iamzoy/minio/internal/config/policy/plugin"
	"github.com/iamzoy/minio/internal/config/scanner"
