...
// and GOROOT directories. Also append github.com/IamZoY/minio
...
func Init(goPath string, goRoot string) {
	...
	// Add "github.com/IamZoY/minio" as the last to cover
	// paths like "{GOROOT}/src/github.com/IamZoY/minio"
	// and "{GOPATH}/src/github.com/IamZoY/minio"
